...
class before_footer {
    ...
    public static function callback(\core\hook\output\before_footer_html_generation $hook): void {
        ...
        // Loaded here inside the method, NOT at file level.
        // File level code runs during hook discovery (too early in bootstrap).
        ...
        // Bulk-load all seen records for this user in one query (avoids N+1).
