...
define(['core/log'], function (Log) {
    ...
    /**
     * Update a check row in the diagnostics table.
     *
     * @param {string}  id  Element ID
     * @param {boolean} ok  Pass or fail
     * @param {string}  msg Optional extra message
     */
    function set_check(id, ok, msg) {
        var el = document.getElementById(id);
        if (el) {
            el.innerHTML = (ok ? '\u2705 YES' : '\u274C NO') + (msg ? ' \u2014 ' + msg : '');
        }
    }

    /**
     * Show the test result banner.
     *
     * @param {string}  msg Result text
    ...
    /**
     * Redirect browser console output to the on-page log element.
     */
    ...
    return {
        /**
         * Initialise the debug diagnostic page.
         */
        init: function () {
            capture_console();
